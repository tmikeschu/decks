## We're not in Ruby-land anymore...
### Debugging the client-side with DevTools

![right](https://media.giphy.com/media/l0MYF44K8NgPSYwRa/giphy.gif)
...
![right fit devtools window][devtools-window]
...
![original fit devtools toolbar][devtools-toolbar]

[devtools-window]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/devtools-window.gif
[devtools-toolbar]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/devtools-toolbar.png
...
![fit Elements Panel][elements-panel]
...
![fit Cant Parse HTML][cant-parse-html]
...
![fit Event Listeners][event-listeners]


[elements-panel]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/elements-panel.png
[find-in-html]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/find-in-html.gif
[editing-text]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/editing-text.gif
[cant-parse-html]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/cant-parse-html.gif
[edit-as-html]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/edit-as-html.gif
[editing-css]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/editing-css.png
[event-listeners]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/event-listeners.gif
...
![inline Console Error][console-error]
...
![fit debugger-pause][debugger-pause]
...
![fit breakpoint-pause][breakpoint-pause]
...
![inline Add watch expression][add-watch]
...
![fit Watch Expressions][watch-expressions]



[console-error]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/console-error.png
[debugger-pause]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/debugger-pause.png
[breakpoint-pause]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/breakpoint-pause.png
[add-watch]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/add-watch.png
[watch-expressions]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/watch-expressions.png
...
![fit Network Panel][network-panel]
...
![inline Network Panel Error][network-panel-error]
...
![fit Request Details][request-details]
...
[network-panel]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/network-panel.png

[network-panel-error]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/network-panel-error.png

[request-details]: http://frontend.turing.io/assets/images/lessons/debugging-with-devtools/request-details.png
